...
object Crud {
    ...
    const val SELECT_ALL_COLUMNS =
        """SELECT country, day, time, MAX(cases_newer) as cases_newer, cases_active, cases_critical, 
            cases_recovered, MAX(cases_total) as cases_total, MAX(deaths_newer) as deaths_newer, 
            deaths_total, tests_total 
            FROM ${ConfigDatabase.TABLE_NAME}"""
